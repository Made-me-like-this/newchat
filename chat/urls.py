...
urlpatterns = [
    ...
    path('api/rooms/<int:room_id>/tasks/', views.room_tasks, name='room_tasks'),
    path('api/messages/<int:message_id>/reactions/', views.message_reactions, name='message_reactions'),
    path('api/messages/<int:message_id>/reply/', views.message_reply, name='message_reply'),
    ...
    path('api/rooms/<int:room_id>/participants/', views.room_participants, name='room_participants'),
    path('api/rooms/<int:room_id>/participants/<int:user_id>/role/', views.change_participant_role, name='change_participant_role'),
    path('api/rooms/<int:room_id>/participants/<int:user_id>/moderate/', views.moderate_participant, name='moderate_participant'),
